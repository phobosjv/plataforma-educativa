# -*- coding: utf-8 -*-
"""Genera docs/manual-v0.11.0.pdf usando fpdf2."""
...
class ManualPDF(FPDF):
    ...
    def header(self) -> None:
        ...
        self.cell(0, 8, "Plataforma Educativa - Manual Tecnico y de Usuario  V-0.11.0", align="L")
    ...
    def cover(self) -> None:
        ...
        self.set_y(58)
        self.cell(0, 10, "Manual Tecnico y de Usuario - V-0.11.0", align="C",
                  new_x="LMARGIN", new_y="NEXT")
        self.set_text_color(*BLACK)
        self.set_y(88)
        ...
        self.multi_cell(
            ...
            "guia de instalacion y manual de uso de la Plataforma Educativa V-0.11.0. "
        ...
        self.cell(0, 6, "Version del software: V-0.11.0", align="C", new_x="LMARGIN", new_y="NEXT")
...
def build_pdf(output_path: str) -> None:
    ...
    pdf.cell(0, 10, "NOVEDADES DE V-0.11.0", align="C",
             new_x="LMARGIN", new_y="NEXT")
    pdf.set_text_color(*BLACK)
    pdf.ln(4)
    pdf.chapter_title("0", "Cambios de esta version")
    pdf.section("Anadido: asignaturas transversales / Aula Abierta")
    pdf.bullet([
        "Una asignatura puede marcarse como TRANSVERSAL (check en Taxonomia): p. ej. Audicion y "
        "Lenguaje, Pedagogia Terapeutica, que no dependen del curso.",
        "Su contenido se saca de la clasificacion por ciclo/curso y se agrupa en 'Aula Abierta'.",
        "Catalogo: tarjeta de acceso (en el inicio y dentro de un curso, solo si hay contenido "
        "transversal) que lleva a las asignaturas transversales y a sus ejercicios.",
        "El contenido transversal NO aparece en el flujo normal de curso/asignatura.",
        "Etiqueta y emoji de 'Aula Abierta' configurables en Apariencia (default Aula Abierta).",
        "En el formulario de contenido, al elegir una asignatura transversal se ocultan ciclo/curso.",
    ])
    pdf.section("Migraciones y notas")
    pdf.bullet([
        "Alembic 008 (asignatura.is_transversal) y 009 (site_config.aula_abierta_label/emoji).",
        "Esquemas API y cliente OpenAPI regenerados (transversal + aula_abierta_*).",
        "149 tests backend + 7 E2E (2 nuevos de Aula Abierta) en verde. API -> 0.11.0.",
    ])
    ...
    pdf.kv_table([
        ...
        ("Total", "123 tests - todos pasan en V-0.11.0"),
    ])
    pdf.code(
        "cd backend\n"
        "pytest -v                        # todos\n"
    ...
    pdf.kv_table([
        ("Hecho (V-0.11.0)", "Robustez: backups automaticos de la BD + purga programada de papelera."),
...
if __name__ == "__main__":
    output = os.path.join(os.path.dirname(os.path.abspath(__file__)), "manual-v0.11.0.pdf")
    build_pdf(output)

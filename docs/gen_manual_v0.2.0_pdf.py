# -*- coding: utf-8 -*-
"""Genera docs/manual-v0.2.0.pdf usando fpdf2."""
...
class ManualPDF(FPDF):
    ...
    def header(self) -> None:
        ...
        self.cell(0, 8, "Plataforma Educativa - Manual Tecnico y de Usuario  V-0.2.0", align="L")
    ...
    def cover(self) -> None:
        ...
        self.set_y(58)
        self.cell(0, 10, "Manual Tecnico y de Usuario - V-0.2.0", align="C",
                  new_x="LMARGIN", new_y="NEXT")
        self.set_text_color(*BLACK)
        self.set_y(88)
        ...
        self.multi_cell(
            ...
            "guia de instalacion y manual de uso de la Plataforma Educativa V-0.2.0. "
            "Esta version introduce el contexto de configuracion con paletas de color, "
            "el frontend React MVP completo, y la gestion CRUD de taxonomias.",
            border=0, fill=True,
        )
        self.ln(5)
        ...
        self.cell(0, 6, "Version del software: V-0.2.0", align="C", new_x="LMARGIN", new_y="NEXT")
...
def build_pdf(output_path: str) -> None:
    ...
    pdf.section("Caracteristicas principales de V-0.2.0")
    pdf.bullet([
    ...
    pdf.section("Contextos acotados implementados en V-0.2.0")
    pdf.kv_table([
    ...
    pdf.code(
        "# 1. Descomprimir\n"
        "unzip plataforma-educativa-v0.2.0.zip && cd plataforma-educativa-v0.2.0\n\n"
    ...
    pdf.kv_table([
        ("cielo", "Cielo Azul - bg #e0f7ff, primary #0284c7"),
        ("bosque", "Bosque Magico - bg #e8f5e9, primary #2e7d32"),
        ("coral", "Coral Feliz - bg #fce4ec, primary #e91e63"),
        ("sol", "Sol Brillante - bg #fff8e1, primary #f59e0b"),
        ("lavanda", "Lavanda Sonadora - bg #f3e5f5, primary #9c27b0"),
        ("estandar", "Estandar - bg #f8fafc, primary #4f46e5"),
    ])
    ...
    pdf.kv_table([
        ("Unitarios (dominio + handlers)", "27 tests - mocks de repositorios"),
        ("Integracion (endpoints)", "40 tests - SQLite en memoria, TestClient FastAPI"),
        ("Total", "67 tests - todos pasan en V-0.2.0"),
    ])
    pdf.code(
        "cd backend\n"
        "pytest -v                        # todos\n"
...
if __name__ == "__main__":
    output = os.path.join(os.path.dirname(os.path.abspath(__file__)), "manual-v0.2.0.pdf")
    build_pdf(output)

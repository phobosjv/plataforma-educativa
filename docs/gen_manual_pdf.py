# -*- coding: latin-1 -*-
"""Script de uso unico: genera docs/manual-v1.0.0.pdf usando fpdf."""
...
class ManualPDF(FPDF):
    ...
    def header(self) -> None:
        ...
        self.cell(0, 8, "Plataforma Educativa - Manual Tecnico y de Usuario  V-1.0.0", align="L")
    ...
    def cover(self) -> None:
        ...
        self.set_y(60)
        self.cell(0, 10, "Manual Tecnico y de Usuario - V-1.0.0", align="C",
                  new_x="LMARGIN", new_y="NEXT")
        self.set_text_color(*BLACK)
        self.set_y(90)
        ...
        self.multi_cell(
            ...
            "en su version inicial (V-1.0.0). Esta dirigido tanto al equipo tecnico "
        ...
        self.cell(0, 6, "Version del software: V-1.0.0", align="C", new_x="LMARGIN", new_y="NEXT")
...
def build_pdf(output_path: str) -> None:
    ...
    pdf.section("Contextos acotados (V-1.0.0 implementados)")
    pdf.kv_table([
    ...
    pdf.code(
        ...
        "unzip plataforma-educativa-v1.0.0.zip\n"
        "cd plataforma-educativa-v1.0.0\n\n"
    ...
    pdf.body(
        "En V-1.0.0 no existe interfaz de administracion web. El primer usuario admin se crea "
    ...
    # 5. API
    pdf.chapter_title("5", "Referencia de la API (V-1.0.0)")
    pdf.body(
    ...
    # 8. Tests
    pdf.chapter_title("8", "Tests (V-1.0.0)")
    pdf.kv_table([
        ...
        ("Total", "46 tests - todos pasan en V-1.0.0"),
    ])
...
if __name__ == "__main__":
    import os
    output = os.path.join(os.path.dirname(os.path.abspath(__file__)), "manual-v1.0.0.pdf")
    build_pdf(output)

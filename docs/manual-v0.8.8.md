# Manual Técnico y de Usuario — Plataforma Educativa V-0.8.8
...
## 0. Novedades de V-0.8.8

Mejora de navegación en el panel de administración.

- **Añadido:** enlace **"↗ Ver la web"** en el sidebar del panel de administración (sobre "Cerrar
  sesión") que lleva al **catálogo público** (`/`). Evita tener que borrar `/admin` de la URL a mano
  para volver a la web pública.

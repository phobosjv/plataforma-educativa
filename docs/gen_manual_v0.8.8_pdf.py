# -*- coding: utf-8 -*-
"""Genera docs/manual-v0.8.8.pdf usando fpdf2."""
...
class ManualPDF(FPDF):
    ...
    def header(self) -> None:
        ...
        self.cell(0, 8, "Plataforma Educativa - Manual Tecnico y de Usuario  V-0.8.8", align="L")
    ...
    def cover(self) -> None:
        ...
        self.set_y(58)
        self.cell(0, 10, "Manual Tecnico y de Usuario - V-0.8.8", align="C",
                  new_x="LMARGIN", new_y="NEXT")
        self.set_text_color(*BLACK)
        self.set_y(88)
        ...
        self.multi_cell(
            ...
            "guia de instalacion y manual de uso de la Plataforma Educativa V-0.8.8. "
            "Esta version anade un enlace 'Ver la web' en el panel de administracion para volver al "
            "catalogo publico sin tener que editar la URL a mano.",
            border=0, fill=True,
        )
        self.ln(5)
        ...
        self.cell(0, 6, "Version del software: V-0.8.8", align="C", new_x="LMARGIN", new_y="NEXT")
...
def build_pdf(output_path: str) -> None:
    ...
    pdf.cell(0, 10, "NOVEDADES DE V-0.8.8", align="C",
             new_x="LMARGIN", new_y="NEXT")
    pdf.set_text_color(*BLACK)
    pdf.ln(4)
    pdf.chapter_title("0", "Cambios de esta version")
    pdf.section("Anadido: enlace 'Ver la web' en el panel admin")
    pdf.bullet([
        "Nuevo enlace 'Ver la web' en el sidebar del panel de administracion (sobre 'Cerrar "
        "sesion') que lleva al catalogo publico (/).",
        "Evita tener que borrar /admin de la URL a mano para volver a la web publica.",
    ])
...
if __name__ == "__main__":
    output = os.path.join(os.path.dirname(os.path.abspath(__file__)), "manual-v0.8.8.pdf")
    build_pdf(output)

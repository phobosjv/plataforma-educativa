# Manual Técnico y de Usuario — Plataforma Educativa V-0.11.0
...
## 0. Novedades de V-0.11.0

**Asignaturas transversales / «Aula Abierta».**

- Una asignatura puede marcarse como **transversal** (check en Taxonomía): p. ej. Audición y Lenguaje
  o Pedagogía Terapéutica, que no dependen del curso. Su contenido se saca de la clasificación por
  ciclo/curso y se agrupa en **«Aula Abierta»**.
- **Catálogo público:** tarjeta de acceso a «Aula Abierta» (en el inicio y dentro de un curso, solo
  si hay contenido transversal) que lleva a las asignaturas transversales y a sus ejercicios,
  agregados de cualquier curso. El contenido transversal **no** aparece en el flujo normal de
  curso/asignatura.
- **Apariencia:** la etiqueta y el emoji de «Aula Abierta» son configurables (default `🌟 Aula
  Abierta`), para que cada centro elija un término inclusivo.
...
- **Migraciones** Alembic `008` (`asignatura.is_transversal`) y `009` (`site_config`). 149 tests
  backend + 7 E2E (2 nuevos de Aula Abierta) en verde. API → `0.11.0`.

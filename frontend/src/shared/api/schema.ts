...
export interface paths {
    ...
    "/ficha/{file_hash}.pdf": {
        ...
        /**
         * Servir Ficha Pdf Dev
         * @description Sirve una ficha PDF desde el origen de la app.
         *
         ...
         */
        get: operations["servir_ficha_pdf_dev_ficha__file_hash__pdf_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/contenidos/{contenido_id}/pdf": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Subir Pdf
         * @description Sube el fichero PDF de una ficha (NO se sanea; se sirve aislado, §10).
         */
        post: operations["subir_pdf_api_v1_contenidos__contenido_id__pdf_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** Body_subir_pdf_api_v1_contenidos__contenido_id__pdf_post */
        Body_subir_pdf_api_v1_contenidos__contenido_id__pdf_post: {
            /** Fichero */
            fichero: string;
        };
...
export interface operations {
    ...
    servir_ficha_pdf_dev_ficha__file_hash__pdf_get: {
        parameters: {
            query?: {
                descargar?: number;
                nombre?: string | null;
    ...
    subir_pdf_api_v1_contenidos__contenido_id__pdf_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "multipart/form-data": components["schemas"]["Body_subir_pdf_api_v1_contenidos__contenido_id__pdf_post"];
            };
        };
        responses: {
            /** @description Successful Response */
